...
var scalar ristretto255.Scalar
if err := scalar.Decode(skBytes); err != nil {
return nil, err
}
...
var point ristretto255.Element
if err := point.Decode(blindedBytes); err != nil {
...
var evaluated ristretto255.Element
evaluated.ScalarMult(scalar, &point)

evaluatedBytes := evaluated.Encode(nil)
return base64.StdEncoding.EncodeToString(evaluatedBytes), nil
}
