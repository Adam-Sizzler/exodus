...
func InternalSquadsHandler(manager *manager.DatabaseManager, cfg *config.BackendConfig) http.HandlerFunc {
...
func handleGetInternalSquads(w http.ResponseWriter, r *http.Request, manager *manager.DatabaseManager, cfg *config.BackendConfig) {
	ctx := r.Context()
...
func handleCreateInternalSquad(w http.ResponseWriter, r *http.Request, manager *manager.DatabaseManager, cfg *config.BackendConfig) {
...
func InternalSquadByUUIDHandler(manager *manager.DatabaseManager, cfg *config.BackendConfig) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleGetInternalSquad(w http.ResponseWriter, r *http.Request, manager *manager.DatabaseManager, cfg *config.BackendConfig, squadUUID string) {
	var squad InternalSquad
	err := manager.ExecuteHighPriority(func(db *sql.DB) error {
...
func handlePatchInternalSquad(w http.ResponseWriter, r *http.Request, manager *manager.DatabaseManager, cfg *config.BackendConfig, squadUUID string) {
...
func handleDeleteInternalSquad(w http.ResponseWriter, r *http.Request, manager *manager.DatabaseManager, cfg *config.BackendConfig, squadUUID string) {
	ctx := r.Context()
