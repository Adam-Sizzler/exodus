...
// Deprecated: task polling flow is removed.
...
type TaskStatusResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskId        string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // deprecated
...
const file_node_proto_rawDesc = "" +
	...
	"\rGetTaskStatus\x12\x18.proto.TaskStatusRequest\x1a\x19.proto.TaskStatusResponse\"\x00B\x13Z\x11exodus-node/protob\x06proto3"
...
var file_node_proto_goTypes = []any{
	...
	(*NodeTask)(nil),              // 17: proto.NodeTask
	(*TaskStatusRequest)(nil),     // 18: proto.TaskStatusRequest
	(*TaskStatusResponse)(nil),    // 19: proto.TaskStatusResponse
	nil,                           // 20: proto.UserLogData.DnsStatsEntry
	nil,                           // 21: proto.GetLogDataResponse.UserLogDataEntry
	nil,                           // 22: proto.OperationResponse.CredentialsEntry
	nil,                           // 23: proto.TaskStatusResponse.CredentialsEntry
	(*status.Status)(nil),         // 24: google.rpc.Status
}
var file_node_proto_depIdxs = []int32{
	0,  // 0: proto.GetApiStatsResponse.stats:type_name -> proto.Stat
	20, // 1: proto.UserLogData.dns_stats:type_name -> proto.UserLogData.DnsStatsEntry
	21, // 2: proto.GetLogDataResponse.user_log_data:type_name -> proto.GetLogDataResponse.UserLogDataEntry
	...
	24, // 10: proto.OperationResponse.status:type_name -> google.rpc.Status
	9,  // 11: proto.OperationResponse.users:type_name -> proto.ListUsersResponse
	22, // 12: proto.OperationResponse.credentials:type_name -> proto.OperationResponse.CredentialsEntry
	9,  // 13: proto.TaskStatusResponse.users:type_name -> proto.ListUsersResponse
	23, // 14: proto.TaskStatusResponse.credentials:type_name -> proto.TaskStatusResponse.CredentialsEntry
	4,  // 15: proto.GetLogDataResponse.UserLogDataEntry.value:type_name -> proto.UserLogData
	8,  // 16: proto.NodeService.ListUsers:input_type -> proto.ListUsersRequest
	1,  // 17: proto.NodeService.GetApiStats:input_type -> proto.GetApiStatsRequest
	3,  // 18: proto.NodeService.GetLogData:input_type -> proto.GetLogDataRequest
	11, // 19: proto.NodeService.StreamNodeData:input_type -> proto.NodeDataRequest
	13, // 20: proto.NodeService.AddUsers:input_type -> proto.AddUsersRequest
	14, // 21: proto.NodeService.DeleteUsers:input_type -> proto.DeleteUsersRequest
	15, // 22: proto.NodeService.SetUserEnabled:input_type -> proto.SetUserEnabledRequest
	17, // 23: proto.NodeService.SubmitTask:input_type -> proto.NodeTask
	18, // 24: proto.NodeService.GetTaskStatus:input_type -> proto.TaskStatusRequest
	9,  // 25: proto.NodeService.ListUsers:output_type -> proto.ListUsersResponse
	2,  // 26: proto.NodeService.GetApiStats:output_type -> proto.GetApiStatsResponse
	5,  // 27: proto.NodeService.GetLogData:output_type -> proto.GetLogDataResponse
	12, // 28: proto.NodeService.StreamNodeData:output_type -> proto.NodeDataResponse
	16, // 29: proto.NodeService.AddUsers:output_type -> proto.OperationResponse
	16, // 30: proto.NodeService.DeleteUsers:output_type -> proto.OperationResponse
	16, // 31: proto.NodeService.SetUserEnabled:output_type -> proto.OperationResponse
	24, // 32: proto.NodeService.SubmitTask:output_type -> google.rpc.Status
	19, // 33: proto.NodeService.GetTaskStatus:output_type -> proto.TaskStatusResponse
