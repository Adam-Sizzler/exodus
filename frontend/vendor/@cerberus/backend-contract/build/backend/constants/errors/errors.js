...
exports.ERRORS = {
    ...
    RESERVED_INTERNAL_SQUAD_NAME: {
        code: 'A144',
        message: 'This name is reserved by Cerberus. Please use a different name.',
        httpCode: 400,
    },
    ...
    GET_REMNAAWAVE_SETTINGS_ERROR: {
        code: 'A192',
        message: 'Get Cerberus settings error',
        httpCode: 500,
    },
    UPDATE_REMNAAWAVE_SETTINGS_ERROR: {
        code: 'A193',
        message: 'Update Cerberus settings error',
        httpCode: 500,
    },
    ...
    VALIDATE_REMNAAWAVE_SETTINGS_ERROR: {
        code: 'A199',
        message: 'Validate Cerberus settings error',
        httpCode: 500,
        withMessage: (message) => ({
            code: 'A199',
            message,
    ...
    INVALID_CERBERUS_INJECTOR: {
        code: 'A216',
        message: 'Invalid Cerberus injector',
        httpCode: 400,
    },
    JOB_CREATION_FAILED: {
        code: 'A217',
