export declare const ERRORS: {
    ...
    readonly RESERVED_INTERNAL_SQUAD_NAME: {
        readonly code: "A144";
        readonly message: "This name is reserved by Cerberus. Please use a different name.";
        readonly httpCode: 400;
    };
    ...
    readonly GET_REMNAAWAVE_SETTINGS_ERROR: {
        readonly code: "A192";
        readonly message: "Get Cerberus settings error";
        readonly httpCode: 500;
    };
    readonly UPDATE_REMNAAWAVE_SETTINGS_ERROR: {
        readonly code: "A193";
        readonly message: "Update Cerberus settings error";
        readonly httpCode: 500;
    };
    ...
    readonly VALIDATE_REMNAAWAVE_SETTINGS_ERROR: {
        readonly code: "A199";
        readonly message: "Validate Cerberus settings error";
        readonly httpCode: 500;
        readonly withMessage: (message: string) => {
            code: string;
            message: string;
    ...
    readonly INVALID_CERBERUS_INJECTOR: {
        readonly code: "A216";
        readonly message: "Invalid Cerberus injector";
        readonly httpCode: 400;
    };
