...
(function (RevokeUserSubscriptionCommand) {
    ...
    RevokeUserSubscriptionCommand.RequestBodySchema = zod_1.z.preprocess((val) => val || {}, zod_1.z.object({
        ...
        shortUuid: zod_1.z.optional(zod_1.z
            ...
            .describe('Optional. If not provided, a new short UUID will be generated by Cerberus. Please note that it is strongly recommended to allow Cerberus to generate the short UUID.')),
    }));
