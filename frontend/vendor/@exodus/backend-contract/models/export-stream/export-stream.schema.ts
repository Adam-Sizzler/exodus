...
export const ExodusUserUsageStreamMessageSchema = z
    .object({
...
export type TExodusUserUsageStreamMessage = z.infer<
    typeof ExodusUserUsageStreamMessageSchema
>;

export const SUBSCRIPTION_REQUEST_STREAM_MESSAGE_VERSION = '1';

export const ExodusSubscriptionRequestStreamMessageSchema = z
    .object({
        v: z
...
export type TExodusSubscriptionRequestStreamMessage = z.infer<
    typeof ExodusSubscriptionRequestStreamMessageSchema
>;
...
export const ExodusNodeConnectionsStreamMessageSchema = z
    .object({
...
export type TExodusNodeConnectionsStreamMessage = z.infer<
    typeof ExodusNodeConnectionsStreamMessageSchema
>;
