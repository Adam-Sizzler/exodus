...
(function (CloneSubscriptionPageConfigCommand) {
    ...
    CloneSubscriptionPageConfigCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.SUBSCRIPTION_PAGE_CONFIGS_ROUTES.ACTIONS.CLONE, 'post', 'Clone subscription page config', { scope: 'clone', kind: 'write' });
