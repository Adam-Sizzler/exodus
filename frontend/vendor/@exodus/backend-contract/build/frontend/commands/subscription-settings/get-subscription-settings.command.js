...
(function (GetSubscriptionSettingsCommand) {
    ...
    GetSubscriptionSettingsCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.SUBSCRIPTION_SETTINGS_ROUTES.GET, 'get', 'Get subscription settings', { scope: 'get', kind: 'read' });
