...
(function (GetSharedListCommand) {
    ...
    GetSharedListCommand.TSQ_url = GetSharedListCommand.url;
    GetSharedListCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.NODE_PLUGINS_ROUTES.SHARED_LISTS.GET, 'get', 'Get Shared List by name', { scope: 'shared-lists-get', kind: 'read' });
    GetSharedListCommand.RequestQuerySchema = zod_1.z.object({
