...
(function (GetSubscriptionTemplatesCommand) {
    ...
    GetSubscriptionTemplatesCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.SUBSCRIPTION_TEMPLATE_ROUTES.GET_ALL, 'get', 'Get all subscription templates (wihout content)', { scope: 'list', kind: 'read' });
