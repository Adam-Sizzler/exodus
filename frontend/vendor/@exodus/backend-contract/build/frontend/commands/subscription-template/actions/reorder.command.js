...
(function (ReorderSubscriptionTemplateCommand) {
    ...
    ReorderSubscriptionTemplateCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.SUBSCRIPTION_TEMPLATE_ROUTES.ACTIONS.REORDER, 'post', 'Reorder subscription templates', { scope: 'reorder', kind: 'write' });
    ReorderSubscriptionTemplateCommand.RequestBodySchema = zod_1.z.object({
