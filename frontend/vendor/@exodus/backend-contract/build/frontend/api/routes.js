...
exports.REST_API = {
    ...
    CONNECTIONS: {
        ...
        GEOCHECK_BY_NODE: (uuid) => `${exports.ROOT}/${CONTROLLERS.CONNECTIONS_CONTROLLER}/${CONTROLLERS.CONNECTIONS_ROUTES.GEOCHECK_BY_NODE(uuid)}`,
        GEOCHECK_BY_NODE_RESULT: (jobId) => `${exports.ROOT}/${CONTROLLERS.CONNECTIONS_CONTROLLER}/${CONTROLLERS.CONNECTIONS_ROUTES.GEOCHECK_BY_NODE_RESULT(jobId)}`,
