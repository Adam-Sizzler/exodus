...
exports.SubscriptionPageConfigSchema = (zod_1.z || zod_1.default.z || zod_1.default).object({
    ...
    config: (zod_1.z || zod_1.default.z || zod_1.default).nullable((zod_1.z || zod_1.default.z || zod_1.default).unknown()),
});
