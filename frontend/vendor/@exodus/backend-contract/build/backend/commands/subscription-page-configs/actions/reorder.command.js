...
(function (ReorderSubscriptionPageConfigsCommand) {
    ...
    ReorderSubscriptionPageConfigsCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.SUBSCRIPTION_PAGE_CONFIGS_ROUTES.ACTIONS.REORDER, 'post', 'Reorder subscription page configs', { scope: 'reorder', kind: 'write' });
