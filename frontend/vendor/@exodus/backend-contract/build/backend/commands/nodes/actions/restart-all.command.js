...
(function (RestartAllNodesCommand) {
    ...
    RestartAllNodesCommand.endpointDetails = (0, constants_1.getEndpointDetails)(api_1.NODES_ROUTES.ACTIONS.RESTART_ALL, 'post', 'Restart all nodes', { scope: 'restart-all', kind: 'write' });
