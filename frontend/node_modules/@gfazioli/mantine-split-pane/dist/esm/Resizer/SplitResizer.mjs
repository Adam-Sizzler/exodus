...
import classes from './SplitResizer.module.css.mjs';
...
const SplitResizer = factory((_props, _) => {
...
export { SplitResizer, defaultProps };
//# sourceMappingURL=SplitResizer.mjs.map
