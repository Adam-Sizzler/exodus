...
import { useRestartSubscriptionConnection } from '@shared/api/hooks'
...
export function RestartNodeButtonFeature(props: IProps) {
    ...
    const { mutate: restartNode, isPending: isRestartNodePending } = useRestartSubscriptionConnection(mutationParams)
