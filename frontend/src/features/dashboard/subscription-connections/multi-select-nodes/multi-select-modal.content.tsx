...
import {
    ...
    useBulkSubscriptionConnectionsActions
} from '@shared/api/hooks'
import { queryClient } from '@shared/api/query-client'
import { ActionCardShared } from '@shared/ui'

type NodeType = SubscriptionConnectionResponse
...
export const MultiSelectNodesModalContent = (props: IProps) => {
    ...
    const { mutateAsync: bulkAction, isPending } = useBulkSubscriptionConnectionsActions()
