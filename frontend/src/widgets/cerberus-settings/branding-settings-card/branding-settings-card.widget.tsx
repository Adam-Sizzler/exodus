...
interface IProps {
    brandingSettings: NonNullable<
        GetCerberusSettingsCommand.Response['response']['brandingSettings']
    >
}
            ...
            <form onSubmit={handleSubmit} style={{ display: 'contents' }}>
                <SettingsCardShared.Container>
                    <SettingsCardShared.Header
                        description={t(
                            'branding-settings-card.widget.customize-your-cerberus-instance'
                        )}
                        icon={<Logo size={24} />}
