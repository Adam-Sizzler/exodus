...
import { subscriptionConnectionsQueryKeys, QueryKeys } from '@shared/api/hooks'
    ...
    const clearInternalStateAndClose = () => {
        ...
        if (nodeUuid) {
            queryClient.removeQueries({
                queryKey: subscriptionConnectionsQueryKeys.getNode({ uuid: nodeUuid.nodeUuid }).queryKey
            })
        }
