...
import { CreateSnippetCommand, UpdateSnippetCommand } from '@exodus/backend-contract'
...
export const SnippetsDrawerWidget = (props: IProps) => {
    ...
    const handleCreate = (values: CreateSnippetCommand.Request) => {
        ...
        try {
            currentValue = JSON.parse(editorRef.current.getValue())
        } catch {
        ...
        createSnippet({
            variables: {
                name: values.name,
                snippet: currentValue as CreateSnippetCommand.Request['snippet']
            }
        })
    }
    ...
    const handleUpdate = (values: UpdateSnippetCommand.Request) => {
        ...
        updateSnippet({
            variables: {
                name: values.name,
                snippet: currentValue as UpdateSnippetCommand.Request['snippet']
            }
        })
    }
