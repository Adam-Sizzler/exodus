...
```
# Замените YOUR_PANEL_DOMAIN на ваш адрес панели Exodus
https://YOUR_PANEL_DOMAIN/oauth2/callback/pocketid
```

### Настройки OAuth2 в Exodus
...
Exodus так же поддерживает авторизацию через добавление Custom Claims.
...
Соотвественно, если пользователь имеет этот ключ (`exodusAccess: true`) в токене, то он будет авторизован.
