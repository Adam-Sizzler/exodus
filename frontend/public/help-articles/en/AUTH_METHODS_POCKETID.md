...
```
# Replace YOUR_PANEL_DOMAIN with your Exodus panel address
https://YOUR_PANEL_DOMAIN/oauth2/callback/pocketid
```

### OAuth2 Settings in Exodus
...
Exodus also supports authorization using Custom Claims.
...
Accordingly, if a user has this key (`exodusAccess: true`) in their token, they will be authorized.
