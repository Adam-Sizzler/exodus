...
Generates and maintains a CSV user credentials file (`/app/haproxy/data/users.csv`) inside the node container for Lua-based authentication in HAProxy.
...
- CSV line format: `1,username,credential`
...
Allows creating global IP lists named `ext:list_name` for reuse across multiple plugins.
...
The **Executor** menu allows sending direct management commands:
